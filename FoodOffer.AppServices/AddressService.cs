...
namespace FoodOffer.AppServices
{
    public class AddressService : IAddressService
    {
        ...
        public AddressService(IAddressRepository addressRepository, ILoginRepository loginRepository)
        {
            _addressRepository = addressRepository ?? throw new ArgumentNullException(nameof(addressRepository));
            _loginRepository = loginRepository ?? throw new ArgumentNullException(nameof(loginRepository));
        }

        //public List<Address> GetAddress(short id, char type)
        //{
        //   return _addressRepository.GetAddresses(id, type);
        //}

        //public List<User> GetUsers(short userId)
        //{
        //    return _addressRepository.GetUsers();
        //}
